...
class Endpoint(KubernetesObject):
    ...
    def __init__(self, addresses: list[str] = None, conditions: EndpointConditions = None, deprecated_topology: dict[str, str] = None, hints: EndpointHints = None, hostname: str = None, node_name: str = None, target_ref: core.ObjectReference = None, zone: str = None):
        super().__init__(addresses=addresses, conditions=conditions, deprecated_topology=deprecated_topology, hints=hints, hostname=hostname, node_name=node_name, target_ref=target_ref, zone=zone)
...
class EndpointSlice(KubernetesApiResource):
    ...
    def __init__(self, name: str, namespace: str = None, address_type: str = None, endpoints: list[Endpoint] = None, metadata: meta.ObjectMeta = None, ports: list[EndpointPort] = None):
