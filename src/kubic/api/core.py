...
class NodeAffinity(KubernetesObject):
    ...
    def __init__(self, preferred_during_scheduling_ignored_during_execution: list[PreferredSchedulingTerm] = None, required_during_scheduling_ignored_during_execution: NodeSelector = None):
...
class PodAffinity(KubernetesObject):
    ...
    def __init__(self, preferred_during_scheduling_ignored_during_execution: list[WeightedPodAffinityTerm] = None, required_during_scheduling_ignored_during_execution: list[PodAffinityTerm] = None):
        super().__init__(preferred_during_scheduling_ignored_during_execution=preferred_during_scheduling_ignored_during_execution, required_during_scheduling_ignored_during_execution=required_during_scheduling_ignored_during_execution)
...
class AzureDiskVolumeSource(KubernetesObject):
    ...
    def __init__(self, caching_mode: str = None, disk_name: str = None, disk_uri: str = None, fs_type: str = None, kind: str = None, read_only: bool = None):
...
class CSIPersistentVolumeSource(KubernetesObject):
    ...
    def __init__(self, controller_expand_secret_ref: SecretReference = None, controller_publish_secret_ref: SecretReference = None, driver: str = None, fs_type: str = None, node_expand_secret_ref: SecretReference = None, node_publish_secret_ref: SecretReference = None, node_stage_secret_ref: SecretReference = None, read_only: bool = None, volume_attributes: dict[str, str] = None, volume_handle: str = None):
        super().__init__(controller_expand_secret_ref=controller_expand_secret_ref, controller_publish_secret_ref=controller_publish_secret_ref, driver=driver, fs_type=fs_type, node_expand_secret_ref=node_expand_secret_ref, node_publish_secret_ref=node_publish_secret_ref, node_stage_secret_ref=node_stage_secret_ref, read_only=read_only, volume_attributes=volume_attributes, volume_handle=volume_handle)
...
class CSIVolumeSource(KubernetesObject):
    ...
    def __init__(self, driver: str = None, fs_type: str = None, node_publish_secret_ref: LocalObjectReference = None, read_only: bool = None, volume_attributes: dict[str, str] = None):
        super().__init__(driver=driver, fs_type=fs_type, node_publish_secret_ref=node_publish_secret_ref, read_only=read_only, volume_attributes=volume_attributes)
...
class CephFSPersistentVolumeSource(KubernetesObject):
    ...
    def __init__(self, monitors: list[str] = None, path: str = None, read_only: bool = None, secret_file: str = None, secret_ref: SecretReference = None, user: str = None):
...
class CephFSVolumeSource(KubernetesObject):
    ...
    def __init__(self, monitors: list[str] = None, path: str = None, read_only: bool = None, secret_file: str = None, secret_ref: LocalObjectReference = None, user: str = None):
        super().__init__(monitors=monitors, path=path, read_only=read_only, secret_file=secret_file, secret_ref=secret_ref, user=user)
...
class ConfigMap(KubernetesApiResource):
    ...
    def __init__(self, name: str, namespace: str = None, binary_data: dict[str, Base64] = None, data: dict[str, str] = None, immutable: bool = None, metadata: meta.ObjectMeta = None):
...
class ConfigMapNodeConfigSource(KubernetesObject):
    ...
    def __init__(self, kubelet_config_key: str = None, name: str = None, namespace: str = None, resource_version: str = None, uid: str = None):
...
class EnvVarSource(KubernetesObject):
    ...
    def __init__(self, config_map_key_ref: ConfigMapKeySelector = None, field_ref: ObjectFieldSelector = None, resource_field_ref: ResourceFieldSelector = None, secret_key_ref: SecretKeySelector = None):
        super().__init__(config_map_key_ref=config_map_key_ref, field_ref=field_ref, resource_field_ref=resource_field_ref, secret_key_ref=secret_key_ref)
...
class HTTPGetAction(KubernetesObject):
    ...
    def __init__(self, host: str = None, http_headers: list[HTTPHeader] = None, path: str = None, port: IntOrString = None, scheme: str = None):
...
class Probe(KubernetesObject):
    ...
    def __init__(self, exec: ExecAction = None, failure_threshold: int = None, grpc: GRPCAction = None, http_get: HTTPGetAction = None, initial_delay_seconds: int = None, period_seconds: int = None, success_threshold: int = None, tcp_socket: TCPSocketAction = None, termination_grace_period_seconds: int = None, timeout_seconds: int = None):
        super().__init__(exec=exec, failure_threshold=failure_threshold, grpc=grpc, http_get=http_get, initial_delay_seconds=initial_delay_seconds, period_seconds=period_seconds, success_threshold=success_threshold, tcp_socket=tcp_socket, termination_grace_period_seconds=termination_grace_period_seconds, timeout_seconds=timeout_seconds)
...
class WindowsSecurityContextOptions(KubernetesObject):
    ...
    def __init__(self, gmsa_credential_spec: str = None, gmsa_credential_spec_name: str = None, host_process: bool = None, run_as_user_name: str = None):
        super().__init__(gmsa_credential_spec=gmsa_credential_spec, gmsa_credential_spec_name=gmsa_credential_spec_name, host_process=host_process, run_as_user_name=run_as_user_name)
...
class SecurityContext(KubernetesObject):
    ...
    def __init__(self, allow_privilege_escalation: bool = None, capabilities: Capabilities = None, privileged: bool = None, proc_mount: str = None, read_only_root_filesystem: bool = None, run_as_group: int = None, run_as_non_root: bool = None, run_as_user: int = None, se_linux_options: SELinuxOptions = None, seccomp_profile: SeccompProfile = None, windows_options: WindowsSecurityContextOptions = None):
        super().__init__(allow_privilege_escalation=allow_privilege_escalation, capabilities=capabilities, privileged=privileged, proc_mount=proc_mount, read_only_root_filesystem=read_only_root_filesystem, run_as_group=run_as_group, run_as_non_root=run_as_non_root, run_as_user=run_as_user, se_linux_options=se_linux_options, seccomp_profile=seccomp_profile, windows_options=windows_options)
...
class VolumeMount(KubernetesObject):
    ...
    def __init__(self, mount_path: str = None, mount_propagation: str = None, name: str = None, read_only: bool = None, sub_path: str = None, sub_path_expr: str = None):
        super().__init__(mount_path=mount_path, mount_propagation=mount_propagation, name=name, read_only=read_only, sub_path=sub_path, sub_path_expr=sub_path_expr)
...
class Container(KubernetesObject):
    ...
    def __init__(self, args: list[str] = None, command: list[str] = None, env: list[EnvVar] = None, env_from: list[EnvFromSource] = None, image: str = None, image_pull_policy: str = None, lifecycle: Lifecycle = None, liveness_probe: Probe = None, name: str = None, ports: list[ContainerPort] = None, readiness_probe: Probe = None, resources: ResourceRequirements = None, security_context: SecurityContext = None, startup_probe: Probe = None, stdin: bool = None, stdin_once: bool = None, termination_message_path: str = None, termination_message_policy: str = None, tty: bool = None, volume_devices: list[VolumeDevice] = None, volume_mounts: list[VolumeMount] = None, working_dir: str = None):
        super().__init__(args=args, command=command, env=env, env_from=env_from, image=image, image_pull_policy=image_pull_policy, lifecycle=lifecycle, liveness_probe=liveness_probe, name=name, ports=ports, readiness_probe=readiness_probe, resources=resources, security_context=security_context, startup_probe=startup_probe, stdin=stdin, stdin_once=stdin_once, termination_message_path=termination_message_path, termination_message_policy=termination_message_policy, tty=tty, volume_devices=volume_devices, volume_mounts=volume_mounts, working_dir=working_dir)
...
class ContainerStateTerminated(KubernetesObject):
    ...
    def __init__(self, container_id: str = None, exit_code: int = None, finished_at: meta.Time = None, message: str = None, reason: str = None, signal: int = None, started_at: meta.Time = None):
        super().__init__(container_id=container_id, exit_code=exit_code, finished_at=finished_at, message=message, reason=reason, signal=signal, started_at=started_at)
...
class ContainerState(KubernetesObject):
    ...
    def __init__(self, running: ContainerStateRunning = None, terminated: ContainerStateTerminated = None, waiting: ContainerStateWaiting = None):
...
class ContainerStatus(KubernetesObject):
    ...
    def __init__(self, container_id: str = None, image: str = None, image_id: str = None, last_state: ContainerState = None, name: str = None, ready: bool = None, restart_count: int = None, started: bool = None, state: ContainerState = None):
        super().__init__(container_id=container_id, image=image, image_id=image_id, last_state=last_state, name=name, ready=ready, restart_count=restart_count, started=started, state=state)
...
class DownwardAPIVolumeFile(KubernetesObject):
    ...
    def __init__(self, field_ref: ObjectFieldSelector = None, mode: int = None, path: str = None, resource_field_ref: ResourceFieldSelector = None):
...
class EndpointSubset(KubernetesObject):
    ...
    def __init__(self, addresses: list[EndpointAddress] = None, not_ready_addresses: list[EndpointAddress] = None, ports: list[EndpointPort] = None):
...
class EphemeralContainer(KubernetesObject):
    ...
    def __init__(self, args: list[str] = None, command: list[str] = None, env: list[EnvVar] = None, env_from: list[EnvFromSource] = None, image: str = None, image_pull_policy: str = None, lifecycle: Lifecycle = None, liveness_probe: Probe = None, name: str = None, ports: list[ContainerPort] = None, readiness_probe: Probe = None, resources: ResourceRequirements = None, security_context: SecurityContext = None, startup_probe: Probe = None, stdin: bool = None, stdin_once: bool = None, target_container_name: str = None, termination_message_path: str = None, termination_message_policy: str = None, tty: bool = None, volume_devices: list[VolumeDevice] = None, volume_mounts: list[VolumeMount] = None, working_dir: str = None):
...
class PersistentVolumeClaimSpec(KubernetesObject):
    ...
    def __init__(self, access_modes: list[str] = None, data_source: TypedLocalObjectReference = None, data_source_ref: TypedLocalObjectReference = None, resources: ResourceRequirements = None, selector: meta.LabelSelector = None, storage_class_name: str = None, volume_mode: str = None, volume_name: str = None):
        super().__init__(access_modes=access_modes, data_source=data_source, data_source_ref=data_source_ref, resources=resources, selector=selector, storage_class_name=storage_class_name, volume_mode=volume_mode, volume_name=volume_name)
...
class Event(KubernetesApiResource):
    ...
    def __init__(self, name: str, namespace: str = None, action: str = None, count: int = None, event_time: meta.MicroTime = None, first_timestamp: meta.Time = None, involved_object: ObjectReference = None, last_timestamp: meta.Time = None, message: str = None, metadata: meta.ObjectMeta = None, reason: str = None, related: ObjectReference = None, reporting_component: str = None, reporting_instance: str = None, series: EventSeries = None, source: EventSource = None, type: str = None):
        super().__init__(name, namespace, action=action, count=count, event_time=event_time, first_timestamp=first_timestamp, involved_object=involved_object, last_timestamp=last_timestamp, message=message, metadata=metadata, reason=reason, related=related, reporting_component=reporting_component, reporting_instance=reporting_instance, series=series, source=source, type=type)
...
class FCVolumeSource(KubernetesObject):
    ...
    def __init__(self, fs_type: str = None, lun: int = None, read_only: bool = None, target_wwns: list[str] = None, wwids: list[str] = None):
...
class FlexPersistentVolumeSource(KubernetesObject):
    ...
    def __init__(self, driver: str = None, fs_type: str = None, options: dict[str, str] = None, read_only: bool = None, secret_ref: SecretReference = None):
...
class FlexVolumeSource(KubernetesObject):
    ...
    def __init__(self, driver: str = None, fs_type: str = None, options: dict[str, str] = None, read_only: bool = None, secret_ref: LocalObjectReference = None):
        super().__init__(driver=driver, fs_type=fs_type, options=options, read_only=read_only, secret_ref=secret_ref)
...
class ISCSIPersistentVolumeSource(KubernetesObject):
    ...
    def __init__(self, chap_auth_discovery: bool = None, chap_auth_session: bool = None, fs_type: str = None, initiator_name: str = None, iqn: str = None, iscsi_interface: str = None, lun: int = None, portals: list[str] = None, read_only: bool = None, secret_ref: SecretReference = None, target_portal: str = None):
        super().__init__(chap_auth_discovery=chap_auth_discovery, chap_auth_session=chap_auth_session, fs_type=fs_type, initiator_name=initiator_name, iqn=iqn, iscsi_interface=iscsi_interface, lun=lun, portals=portals, read_only=read_only, secret_ref=secret_ref, target_portal=target_portal)
...
class ISCSIVolumeSource(KubernetesObject):
    ...
    def __init__(self, chap_auth_discovery: bool = None, chap_auth_session: bool = None, fs_type: str = None, initiator_name: str = None, iqn: str = None, iscsi_interface: str = None, lun: int = None, portals: list[str] = None, read_only: bool = None, secret_ref: LocalObjectReference = None, target_portal: str = None):
        super().__init__(chap_auth_discovery=chap_auth_discovery, chap_auth_session=chap_auth_session, fs_type=fs_type, initiator_name=initiator_name, iqn=iqn, iscsi_interface=iscsi_interface, lun=lun, portals=portals, read_only=read_only, secret_ref=secret_ref, target_portal=target_portal)
...
class Info(KubernetesObject):
    ...
    def __init__(self, build_date: str = None, compiler: str = None, git_commit: str = None, git_tree_state: str = None, git_version: str = None, go_version: str = None, major: str = None, minor: str = None, platform: str = None):
        super().__init__(build_date=build_date, compiler=compiler, git_commit=git_commit, git_tree_state=git_tree_state, git_version=git_version, go_version=go_version, major=major, minor=minor, platform=platform)
...
class LimitRangeItem(KubernetesObject):
    ...
    def __init__(self, default: dict[str, Quantity] = None, default_request: dict[str, Quantity] = None, max: dict[str, Quantity] = None, max_limit_request_ratio: dict[str, Quantity] = None, min: dict[str, Quantity] = None, type: str = None):
        super().__init__(default=default, default_request=default_request, max=max, max_limit_request_ratio=max_limit_request_ratio, min=min, type=type)
...
class NodeSpec(KubernetesObject):
    ...
    def __init__(self, config_source: NodeConfigSource = None, external_id: str = None, pod_cidr: str = None, pod_cidrs: list[str] = None, provider_id: str = None, taints: list[Taint] = None, unschedulable: bool = None):
        super().__init__(config_source=config_source, external_id=external_id, pod_cidr=pod_cidr, pod_cidrs=pod_cidrs, provider_id=provider_id, taints=taints, unschedulable=unschedulable)
...
class NodeCondition(KubernetesObject):
    ...
    def __init__(self, last_heartbeat_time: meta.Time = None, last_transition_time: meta.Time = None, message: str = None, reason: str = None, status: str = None, type: str = None):
        super().__init__(last_heartbeat_time=last_heartbeat_time, last_transition_time=last_transition_time, message=message, reason=reason, status=status, type=type)
...
class NodeConfigStatus(KubernetesObject):
    ...
    def __init__(self, active: NodeConfigSource = None, assigned: NodeConfigSource = None, error: str = None, last_known_good: NodeConfigSource = None):
...
class NodeSystemInfo(KubernetesObject):
    ...
    _required_ = ["architecture", "boot_id", "container_runtime_version", "kernel_version", "kube_proxy_version", "kubelet_version", "machine_id", "operating_system", "os_image", "system_uuid"]
    ...
    def __init__(self, architecture: str = None, boot_id: str = None, container_runtime_version: str = None, kernel_version: str = None, kube_proxy_version: str = None, kubelet_version: str = None, machine_id: str = None, operating_system: str = None, os_image: str = None, system_uuid: str = None):
        super().__init__(architecture=architecture, boot_id=boot_id, container_runtime_version=container_runtime_version, kernel_version=kernel_version, kube_proxy_version=kube_proxy_version, kubelet_version=kubelet_version, machine_id=machine_id, operating_system=operating_system, os_image=os_image, system_uuid=system_uuid)
...
class NodeStatus(KubernetesObject):
    ...
    def __init__(self, addresses: list[NodeAddress] = None, allocatable: dict[str, Quantity] = None, capacity: dict[str, Quantity] = None, conditions: list[NodeCondition] = None, config: NodeConfigStatus = None, daemon_endpoints: NodeDaemonEndpoints = None, images: list[ContainerImage] = None, node_info: NodeSystemInfo = None, phase: str = None, volumes_attached: list[AttachedVolume] = None, volumes_in_use: list[str] = None):
        super().__init__(addresses=addresses, allocatable=allocatable, capacity=capacity, conditions=conditions, config=config, daemon_endpoints=daemon_endpoints, images=images, node_info=node_info, phase=phase, volumes_attached=volumes_attached, volumes_in_use=volumes_in_use)
...
class QuobyteVolumeSource(KubernetesObject):
    ...
    def __init__(self, group: str = None, read_only: bool = None, registry: str = None, tenant: str = None, user: str = None, volume: str = None):
...
class RBDPersistentVolumeSource(KubernetesObject):
    ...
    def __init__(self, fs_type: str = None, image: str = None, keyring: str = None, monitors: list[str] = None, pool: str = None, read_only: bool = None, secret_ref: SecretReference = None, user: str = None):
        super().__init__(fs_type=fs_type, image=image, keyring=keyring, monitors=monitors, pool=pool, read_only=read_only, secret_ref=secret_ref, user=user)
...
class ScaleIOPersistentVolumeSource(KubernetesObject):
    ...
    def __init__(self, fs_type: str = None, gateway: str = None, protection_domain: str = None, read_only: bool = None, secret_ref: SecretReference = None, ssl_enabled: bool = None, storage_mode: str = None, storage_pool: str = None, system: str = None, volume_name: str = None):
        super().__init__(fs_type=fs_type, gateway=gateway, protection_domain=protection_domain, read_only=read_only, secret_ref=secret_ref, ssl_enabled=ssl_enabled, storage_mode=storage_mode, storage_pool=storage_pool, system=system, volume_name=volume_name)
...
class StorageOSPersistentVolumeSource(KubernetesObject):
    ...
    def __init__(self, fs_type: str = None, read_only: bool = None, secret_ref: ObjectReference = None, volume_name: str = None, volume_namespace: str = None):
        super().__init__(fs_type=fs_type, read_only=read_only, secret_ref=secret_ref, volume_name=volume_name, volume_namespace=volume_namespace)
...
class VsphereVirtualDiskVolumeSource(KubernetesObject):
    ...
    def __init__(self, fs_type: str = None, storage_policy_id: str = None, storage_policy_name: str = None, volume_path: str = None):
        super().__init__(fs_type=fs_type, storage_policy_id=storage_policy_id, storage_policy_name=storage_policy_name, volume_path=volume_path)
...
class PersistentVolumeSpec(KubernetesObject):
    ...
    def __init__(self, access_modes: list[str] = None, aws_elastic_block_store: AWSElasticBlockStoreVolumeSource = None, azure_disk: AzureDiskVolumeSource = None, azure_file: AzureFilePersistentVolumeSource = None, capacity: dict[str, Quantity] = None, cephfs: CephFSPersistentVolumeSource = None, cinder: CinderPersistentVolumeSource = None, claim_ref: ObjectReference = None, csi: CSIPersistentVolumeSource = None, fc: FCVolumeSource = None, flex_volume: FlexPersistentVolumeSource = None, flocker: FlockerVolumeSource = None, gce_persistent_disk: GCEPersistentDiskVolumeSource = None, glusterfs: GlusterfsPersistentVolumeSource = None, host_path: HostPathVolumeSource = None, iscsi: ISCSIPersistentVolumeSource = None, local: LocalVolumeSource = None, mount_options: list[str] = None, nfs: NFSVolumeSource = None, node_affinity: VolumeNodeAffinity = None, persistent_volume_reclaim_policy: str = None, photon_persistent_disk: PhotonPersistentDiskVolumeSource = None, portworx_volume: PortworxVolumeSource = None, quobyte: QuobyteVolumeSource = None, rbd: RBDPersistentVolumeSource = None, scale_io: ScaleIOPersistentVolumeSource = None, storage_class_name: str = None, storageos: StorageOSPersistentVolumeSource = None, volume_mode: str = None, vsphere_volume: VsphereVirtualDiskVolumeSource = None):
        super().__init__(access_modes=access_modes, aws_elastic_block_store=aws_elastic_block_store, azure_disk=azure_disk, azure_file=azure_file, capacity=capacity, cephfs=cephfs, cinder=cinder, claim_ref=claim_ref, csi=csi, fc=fc, flex_volume=flex_volume, flocker=flocker, gce_persistent_disk=gce_persistent_disk, glusterfs=glusterfs, host_path=host_path, iscsi=iscsi, local=local, mount_options=mount_options, nfs=nfs, node_affinity=node_affinity, persistent_volume_reclaim_policy=persistent_volume_reclaim_policy, photon_persistent_disk=photon_persistent_disk, portworx_volume=portworx_volume, quobyte=quobyte, rbd=rbd, scale_io=scale_io, storage_class_name=storage_class_name, storageos=storageos, volume_mode=volume_mode, vsphere_volume=vsphere_volume)
...
class PersistentVolumeClaimCondition(KubernetesObject):
    ...
    def __init__(self, last_probe_time: meta.Time = None, last_transition_time: meta.Time = None, message: str = None, reason: str = None, status: str = None, type: str = None):
        super().__init__(last_probe_time=last_probe_time, last_transition_time=last_transition_time, message=message, reason=reason, status=status, type=type)
...
class PersistentVolumeClaimStatus(KubernetesObject):
    ...
    def __init__(self, access_modes: list[str] = None, allocated_resources: dict[str, Quantity] = None, capacity: dict[str, Quantity] = None, conditions: list[PersistentVolumeClaimCondition] = None, phase: str = None, resize_status: str = None):
        super().__init__(access_modes=access_modes, allocated_resources=allocated_resources, capacity=capacity, conditions=conditions, phase=phase, resize_status=resize_status)
...
class PodSecurityContext(KubernetesObject):
    ...
    def __init__(self, fs_group: int = None, fs_group_change_policy: str = None, run_as_group: int = None, run_as_non_root: bool = None, run_as_user: int = None, se_linux_options: SELinuxOptions = None, seccomp_profile: SeccompProfile = None, supplemental_groups: list[int] = None, sysctls: list[Sysctl] = None, windows_options: WindowsSecurityContextOptions = None):
        super().__init__(fs_group=fs_group, fs_group_change_policy=fs_group_change_policy, run_as_group=run_as_group, run_as_non_root=run_as_non_root, run_as_user=run_as_user, se_linux_options=se_linux_options, seccomp_profile=seccomp_profile, supplemental_groups=supplemental_groups, sysctls=sysctls, windows_options=windows_options)
...
class TopologySpreadConstraint(KubernetesObject):
    ...
    def __init__(self, label_selector: meta.LabelSelector = None, match_label_keys: list[str] = None, max_skew: int = None, min_domains: int = None, node_affinity_policy: str = None, node_taints_policy: str = None, topology_key: str = None, when_unsatisfiable: str = None):
        super().__init__(label_selector=label_selector, match_label_keys=match_label_keys, max_skew=max_skew, min_domains=min_domains, node_affinity_policy=node_affinity_policy, node_taints_policy=node_taints_policy, topology_key=topology_key, when_unsatisfiable=when_unsatisfiable)
...
class VolumeProjection(KubernetesObject):
    ...
    def __init__(self, config_map: ConfigMapProjection = None, downward_api: DownwardAPIProjection = None, secret: SecretProjection = None, service_account_token: ServiceAccountTokenProjection = None):
...
class RBDVolumeSource(KubernetesObject):
    ...
    def __init__(self, fs_type: str = None, image: str = None, keyring: str = None, monitors: list[str] = None, pool: str = None, read_only: bool = None, secret_ref: LocalObjectReference = None, user: str = None):
        super().__init__(fs_type=fs_type, image=image, keyring=keyring, monitors=monitors, pool=pool, read_only=read_only, secret_ref=secret_ref, user=user)
...
class ScaleIOVolumeSource(KubernetesObject):
    ...
    def __init__(self, fs_type: str = None, gateway: str = None, protection_domain: str = None, read_only: bool = None, secret_ref: LocalObjectReference = None, ssl_enabled: bool = None, storage_mode: str = None, storage_pool: str = None, system: str = None, volume_name: str = None):
        super().__init__(fs_type=fs_type, gateway=gateway, protection_domain=protection_domain, read_only=read_only, secret_ref=secret_ref, ssl_enabled=ssl_enabled, storage_mode=storage_mode, storage_pool=storage_pool, system=system, volume_name=volume_name)
...
class StorageOSVolumeSource(KubernetesObject):
    ...
    def __init__(self, fs_type: str = None, read_only: bool = None, secret_ref: LocalObjectReference = None, volume_name: str = None, volume_namespace: str = None):
        super().__init__(fs_type=fs_type, read_only=read_only, secret_ref=secret_ref, volume_name=volume_name, volume_namespace=volume_namespace)
...
class Volume(KubernetesObject):
    ...
    def __init__(self, aws_elastic_block_store: AWSElasticBlockStoreVolumeSource = None, azure_disk: AzureDiskVolumeSource = None, azure_file: AzureFileVolumeSource = None, cephfs: CephFSVolumeSource = None, cinder: CinderVolumeSource = None, config_map: ConfigMapVolumeSource = None, csi: CSIVolumeSource = None, downward_api: DownwardAPIVolumeSource = None, empty_dir: EmptyDirVolumeSource = None, ephemeral: EphemeralVolumeSource = None, fc: FCVolumeSource = None, flex_volume: FlexVolumeSource = None, flocker: FlockerVolumeSource = None, gce_persistent_disk: GCEPersistentDiskVolumeSource = None, git_repo: GitRepoVolumeSource = None, glusterfs: GlusterfsVolumeSource = None, host_path: HostPathVolumeSource = None, iscsi: ISCSIVolumeSource = None, name: str = None, nfs: NFSVolumeSource = None, persistent_volume_claim: PersistentVolumeClaimVolumeSource = None, photon_persistent_disk: PhotonPersistentDiskVolumeSource = None, portworx_volume: PortworxVolumeSource = None, projected: ProjectedVolumeSource = None, quobyte: QuobyteVolumeSource = None, rbd: RBDVolumeSource = None, scale_io: ScaleIOVolumeSource = None, secret: SecretVolumeSource = None, storageos: StorageOSVolumeSource = None, vsphere_volume: VsphereVirtualDiskVolumeSource = None):
        super().__init__(aws_elastic_block_store=aws_elastic_block_store, azure_disk=azure_disk, azure_file=azure_file, cephfs=cephfs, cinder=cinder, config_map=config_map, csi=csi, downward_api=downward_api, empty_dir=empty_dir, ephemeral=ephemeral, fc=fc, flex_volume=flex_volume, flocker=flocker, gce_persistent_disk=gce_persistent_disk, git_repo=git_repo, glusterfs=glusterfs, host_path=host_path, iscsi=iscsi, name=name, nfs=nfs, persistent_volume_claim=persistent_volume_claim, photon_persistent_disk=photon_persistent_disk, portworx_volume=portworx_volume, projected=projected, quobyte=quobyte, rbd=rbd, scale_io=scale_io, secret=secret, storageos=storageos, vsphere_volume=vsphere_volume)
...
class PodSpec(KubernetesObject):
    ...
    def __init__(self, active_deadline_seconds: int = None, affinity: Affinity = None, automount_service_account_token: bool = None, containers: list[Container] = None, dns_config: PodDNSConfig = None, dns_policy: str = None, enable_service_links: bool = None, ephemeral_containers: list[EphemeralContainer] = None, host_aliases: list[HostAlias] = None, host_ipc: bool = None, host_network: bool = None, host_pid: bool = None, host_users: bool = None, hostname: str = None, image_pull_secrets: list[LocalObjectReference] = None, init_containers: list[Container] = None, node_name: str = None, node_selector: dict[str, str] = None, os: PodOS = None, overhead: dict[str, Quantity] = None, preemption_policy: str = None, priority: int = None, priority_class_name: str = None, readiness_gates: list[PodReadinessGate] = None, restart_policy: str = None, runtime_class_name: str = None, scheduler_name: str = None, security_context: PodSecurityContext = None, service_account: str = None, service_account_name: str = None, set_hostname_as_fqdn: bool = None, share_process_namespace: bool = None, subdomain: str = None, termination_grace_period_seconds: int = None, tolerations: list[Toleration] = None, topology_spread_constraints: list[TopologySpreadConstraint] = None, volumes: list[Volume] = None):
        super().__init__(active_deadline_seconds=active_deadline_seconds, affinity=affinity, automount_service_account_token=automount_service_account_token, containers=containers, dns_config=dns_config, dns_policy=dns_policy, enable_service_links=enable_service_links, ephemeral_containers=ephemeral_containers, host_aliases=host_aliases, host_ipc=host_ipc, host_network=host_network, host_pid=host_pid, host_users=host_users, hostname=hostname, image_pull_secrets=image_pull_secrets, init_containers=init_containers, node_name=node_name, node_selector=node_selector, os=os, overhead=overhead, preemption_policy=preemption_policy, priority=priority, priority_class_name=priority_class_name, readiness_gates=readiness_gates, restart_policy=restart_policy, runtime_class_name=runtime_class_name, scheduler_name=scheduler_name, security_context=security_context, service_account=service_account, service_account_name=service_account_name, set_hostname_as_fqdn=set_hostname_as_fqdn, share_process_namespace=share_process_namespace, subdomain=subdomain, termination_grace_period_seconds=termination_grace_period_seconds, tolerations=tolerations, topology_spread_constraints=topology_spread_constraints, volumes=volumes)
...
class PodStatus(KubernetesObject):
    ...
    def __init__(self, conditions: list[PodCondition] = None, container_statuses: list[ContainerStatus] = None, ephemeral_container_statuses: list[ContainerStatus] = None, host_ip: str = None, init_container_statuses: list[ContainerStatus] = None, message: str = None, nominated_node_name: str = None, phase: str = None, pod_ip: str = None, pod_ips: list[PodIP] = None, qos_class: str = None, reason: str = None, start_time: meta.Time = None):
        super().__init__(conditions=conditions, container_statuses=container_statuses, ephemeral_container_statuses=ephemeral_container_statuses, host_ip=host_ip, init_container_statuses=init_container_statuses, message=message, nominated_node_name=nominated_node_name, phase=phase, pod_ip=pod_ip, pod_ips=pod_ips, qos_class=qos_class, reason=reason, start_time=start_time)
...
class ReplicationControllerSpec(KubernetesObject):
    ...
    def __init__(self, min_ready_seconds: int = None, replicas: int = None, selector: dict[str, str] = None, template: PodTemplateSpec = None):
...
class ReplicationControllerStatus(KubernetesObject):
    ...
    def __init__(self, available_replicas: int = None, conditions: list[ReplicationControllerCondition] = None, fully_labeled_replicas: int = None, observed_generation: int = None, ready_replicas: int = None, replicas: int = None):
...
class Secret(KubernetesApiResource):
    ...
    def __init__(self, name: str, namespace: str = None, data: dict[str, Base64] = None, immutable: bool = None, metadata: meta.ObjectMeta = None, string_data: dict[str, str] = None, type: str = None):
...
class ServiceSpec(KubernetesObject):
    ...
    def __init__(self, allocate_load_balancer_node_ports: bool = None, cluster_ip: str = None, cluster_ips: list[str] = None, external_ips: list[str] = None, external_name: str = None, external_traffic_policy: str = None, health_check_node_port: int = None, internal_traffic_policy: str = None, ip_families: list[str] = None, ip_family_policy: str = None, load_balancer_class: str = None, load_balancer_ip: str = None, load_balancer_source_ranges: list[str] = None, ports: list[ServicePort] = None, publish_not_ready_addresses: bool = None, selector: dict[str, str] = None, session_affinity: str = None, session_affinity_config: SessionAffinityConfig = None, type: str = None):
        super().__init__(allocate_load_balancer_node_ports=allocate_load_balancer_node_ports, cluster_ip=cluster_ip, cluster_ips=cluster_ips, external_ips=external_ips, external_name=external_name, external_traffic_policy=external_traffic_policy, health_check_node_port=health_check_node_port, internal_traffic_policy=internal_traffic_policy, ip_families=ip_families, ip_family_policy=ip_family_policy, load_balancer_class=load_balancer_class, load_balancer_ip=load_balancer_ip, load_balancer_source_ranges=load_balancer_source_ranges, ports=ports, publish_not_ready_addresses=publish_not_ready_addresses, selector=selector, session_affinity=session_affinity, session_affinity_config=session_affinity_config, type=type)
...
class ServiceAccount(KubernetesApiResource):
    ...
    def __init__(self, name: str, namespace: str = None, automount_service_account_token: bool = None, image_pull_secrets: list[LocalObjectReference] = None, metadata: meta.ObjectMeta = None, secrets: list[ObjectReference] = None):
        super().__init__(name, namespace, automount_service_account_token=automount_service_account_token, image_pull_secrets=image_pull_secrets, metadata=metadata, secrets=secrets)
