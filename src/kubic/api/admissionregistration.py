...
class ApplyConfiguration(KubernetesObject):
...
class JSONPatch(KubernetesObject):
...
class Mutation(KubernetesObject):
    ...
    def __init__(self, apply_configuration: ApplyConfiguration = None, json_patch: JSONPatch = None, patch_type: str = None):
        super().__init__(apply_configuration=apply_configuration, json_patch=json_patch, patch_type=patch_type)
...
class MutatingAdmissionPolicySpec(KubernetesObject):
...
class MutatingAdmissionPolicy(KubernetesApiResource):
    ...
    _kind_ = "MutatingAdmissionPolicy"
    _scope_ = "namespace"
    ...
    def __init__(self, name: str, namespace: str = None, metadata: meta.ObjectMeta = None, spec: MutatingAdmissionPolicySpec = None):
...
class MutatingAdmissionPolicyBindingSpec(KubernetesObject):
    ...
    def __init__(self, match_resources: MatchResources = None, param_ref: ParamRef = None, policy_name: str = None):
        super().__init__(match_resources=match_resources, param_ref=param_ref, policy_name=policy_name)


class MutatingAdmissionPolicyBinding(KubernetesApiResource):
    """
    ...
    _api_version_ = "admissionregistration.k8s.io/v1alpha1"
    _api_group_ = "admissionregistration.k8s.io"
    _kind_ = "MutatingAdmissionPolicyBinding"
    _scope_ = "namespace"
    ...
    def __init__(self, name: str, namespace: str = None, metadata: meta.ObjectMeta = None, spec: MutatingAdmissionPolicyBindingSpec = None):
        super().__init__(name, namespace, metadata=metadata, spec=spec)
