...
class HPAScalingRules(KubernetesObject):
    ...
    def __init__(
        ...
        tolerance: core.Quantity = None,
    ):
        super().__init__(
            policies=policies, select_policy=select_policy, stabilization_window_seconds=stabilization_window_seconds, tolerance=tolerance
        )
