...
class PodFailurePolicyRule(KubernetesObject):
    ...
    def __init__(self, action: str = None, on_exit_codes: PodFailurePolicyOnExitCodesRequirement = None, on_pod_conditions: list[PodFailurePolicyOnPodConditionsPattern] = None):
...
class JobSpec(KubernetesObject):
    ...
    def __init__(self, active_deadline_seconds: int = None, backoff_limit: int = None, completion_mode: str = None, completions: int = None, manual_selector: bool = None, parallelism: int = None, pod_failure_policy: PodFailurePolicy = None, selector: meta.LabelSelector = None, suspend: bool = None, template: core.PodTemplateSpec = None, ttl_seconds_after_finished: int = None):
        super().__init__(active_deadline_seconds=active_deadline_seconds, backoff_limit=backoff_limit, completion_mode=completion_mode, completions=completions, manual_selector=manual_selector, parallelism=parallelism, pod_failure_policy=pod_failure_policy, selector=selector, suspend=suspend, template=template, ttl_seconds_after_finished=ttl_seconds_after_finished)
...
class CronJobSpec(KubernetesObject):
    ...
    def __init__(self, concurrency_policy: str = None, failed_jobs_history_limit: int = None, job_template: JobTemplateSpec = None, schedule: str = None, starting_deadline_seconds: int = None, successful_jobs_history_limit: int = None, suspend: bool = None, time_zone: str = None):
        super().__init__(concurrency_policy=concurrency_policy, failed_jobs_history_limit=failed_jobs_history_limit, job_template=job_template, schedule=schedule, starting_deadline_seconds=starting_deadline_seconds, successful_jobs_history_limit=successful_jobs_history_limit, suspend=suspend, time_zone=time_zone)
...
class CronJobStatus(KubernetesObject):
    ...
    def __init__(self, active: list[core.ObjectReference] = None, last_schedule_time: meta.Time = None, last_successful_time: meta.Time = None):
...
class JobStatus(KubernetesObject):
    ...
    def __init__(self, active: int = None, completed_indexes: str = None, completion_time: meta.Time = None, conditions: list[JobCondition] = None, failed: int = None, ready: int = None, start_time: meta.Time = None, succeeded: int = None, uncounted_terminated_pods: UncountedTerminatedPods = None):
        super().__init__(active=active, completed_indexes=completed_indexes, completion_time=completion_time, conditions=conditions, failed=failed, ready=ready, start_time=start_time, succeeded=succeeded, uncounted_terminated_pods=uncounted_terminated_pods)
