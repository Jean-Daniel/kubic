...
class LivenessProbe(KubernetesObject):
    ...
    def __init__(self, disabled: bool = None, probe: Probe = None):
...
class CephClusterSpecHealthCheck(KubernetesObject):
    ...
    liveness_probe: Dict[str, LivenessProbe]

    def __init__(self, daemon_health: DaemonHealth = None, liveness_probe: Dict[str, LivenessProbe] = None):
...
class PreparePlacement(KubernetesObject):
    __slots__ = ()
...
class StorageClassDeviceSet(KubernetesObject):
    ...
    def __init__(
        ...
        portable: bool = None,
        prepare_placement: PreparePlacement = None,
        resources: Resource = None,
...
class DataPoolMirroring(KubernetesObject):
    __slots__ = ()
...
class DataPoolQuota(KubernetesObject):
    __slots__ = ()
...
class DataPool(KubernetesObject):
    __slots__ = ()
    ...
    erasure_coded: ErasureCoded
    failure_domain: str
    mirroring: DataPoolMirroring
    parameters: Dict[str, str]
    quotas: DataPoolQuota
    replicated: Replicated
    status_check: StatusCheck
    ...
    def __init__(
        ...
        erasure_coded: ErasureCoded = None,
        failure_domain: str = None,
        mirroring: DataPoolMirroring = None,
        parameters: Dict[str, str] = None,
        quotas: DataPoolQuota = None,
        replicated: Replicated = None,
        status_check: StatusCheck = None,
    ):
        super().__init__(
...
class MetadataPoolMirroring(KubernetesObject):
    __slots__ = ()
...
class MetadataPoolQuota(KubernetesObject):
    __slots__ = ()
...
class MetadataPool(KubernetesObject):
    __slots__ = ()
    ...
    erasure_coded: ErasureCoded
    failure_domain: str
    mirroring: MetadataPoolMirroring
    parameters: Dict[str, str]
    quotas: MetadataPoolQuota
    replicated: Replicated
    status_check: StatusCheck
    ...
    def __init__(
        ...
        erasure_coded: ErasureCoded = None,
        failure_domain: str = None,
        mirroring: MetadataPoolMirroring = None,
        parameters: Dict[str, str] = None,
        quotas: MetadataPoolQuota = None,
        replicated: Replicated = None,
        status_check: StatusCheck = None,
    ):
        super().__init__(
...
class CephFilesystemSpec(KubernetesObject):
    ...
    def __init__(
        self,
        data_pools: List[DataPool] = None,
        metadata_pool: MetadataPool = None,
...
class CephObjectStoreSpecHealthCheck(KubernetesObject):
    ...
    def __init__(self, bucket: Bucket = None, liveness_probe: LivenessProbe = None):
...
class CephObjectZoneSpec(KubernetesObject):
    ...
    def __init__(self, data_pool: DataPool = None, metadata_pool: MetadataPool = None, zone_group: str = None):
